...
/******************************** Configuration of CR1******************************************/
	...
	// Enable the USART recieve transmit engines depending on user preference.
    ...
    // Configure the Word length register value.
...
/*************************Check for TC flag ********************************************/
	...
	temp1 = pUSARTHandle->pUSARTx->USART_SR & ( 1 << USART_SR1_TC);
	...
	if(temp1 && temp2 )
	{
		...
		if ( pUSARTHandle->TxBusyState == USART_BUSY_IN_TX)
		{
			...
			{
				// Clear the TC flag
				pUSARTHandle->pUSARTx->USART_SR &= ~( 1 << USART_SR1_TC);
...
/*************************Check for TXE flag ********************************************/
	...
	temp1 = pUSARTHandle->pUSARTx->USART_SR & ( 1 << USART_SR1_TXE);
...
/*************************Check for RXNE flag ********************************************/
	...
	temp1 = pUSARTHandle->pUSARTx->USART_SR & ( 1 << USART_SR1_RXNE);
...
//Note : CTS feature is not applicable for UART4 and UART5
	...
	temp1 = pUSARTHandle->pUSARTx->USART_SR & (1 << USART_SR1_CTS);
	...
	if(temp1  && temp2 )
	{
		...
		pUSARTHandle->pUSARTx->USART_SR &= ~(1 << USART_SR1_CTS);
...
/*************************Check for IDLE detection flag ********************************************/
	...
	temp1 = pUSARTHandle->pUSARTx->USART_SR & (1 << USART_SR1_IDLE);
...
/*************************Check for Overrun detection flag ********************************************/
	...
	temp1 = pUSARTHandle->pUSARTx->USART_SR & (1 << USART_SR1_ORE);
